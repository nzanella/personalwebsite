...
class MenuTreeToPagesData {
  ...
  public function getPageURLSlug() {
   ...
   if (ConfigSettings::URL_SCHEME_QUERYSTRING) {

   }

  }

  public function getSelectedNode($nodeLevel) {

  }

// inside page-header.php use .... getSelectedNode($level)->getChildren() etc...
...
class MenuTreeNode extends TreeNode {
  ...
  public function getPageLink() {
    ...
    if (ConfigSettings::URL_SCHEME_QUERYSTRING) {
      ...
      $pageURL = $pageSettings->currentPageURLArray[$lang];
